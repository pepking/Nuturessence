(function($) {
    ...
    var slide = function(ele,options) {
        ...
        var states = [
            { $zIndex: 1, width: 70, height: 120, top: 69, left: 134, $opacity: 0.2 },
            { $zIndex: 2, width: 80, height: 140, top: 59, left: 0, $opacity: 0.4 },
            { $zIndex: 3, width: 120, height: 188, top: 35, left: 110, $opacity: 0.7 },
            { $zIndex: 4, width: 224, height: 288, top: 0, left: 263, $opacity: 1 },
            { $zIndex: 3, width: 120, height: 188, top: 35, left: 470, $opacity: 0.7 },
